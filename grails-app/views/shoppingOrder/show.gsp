...
<html>
    ...
    <body>
        ...
        <div id="show-shoppingOrder" class="content scaffold-show" role="main">
            ...
            <f:display bean="shoppingOrder" />
            <g:form resource="${this.shoppingOrder}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.shoppingOrder}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
